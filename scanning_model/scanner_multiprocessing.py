...
# python scanning_model/scanner_multiprocessing.py
...
def process_tss_group(args):
    ...
    for idx, row in df_tss.iterrows():
        ...
        print(scan_promoter(tss_loc, direction, genome, tss_m10_range))
        if 'N' not in scan_promoter(tss_loc, direction, genome, tss_m10_range):
...
if __name__ == '__main__':
    ...
    TSS = pd.read_csv("./raw_data/tss_test.tsv", sep="\t")
